        ...
        with webdriver.Chrome(service=service, options=chrome_options) as driver:
            ...
            try:
                ...
                for i in range(1, len(song_lists)):
                    ...
                    #아티스트 정보 찾기
                    # 19금 노래의 경우 span[1]에 19금표시, [2]에 아티스트 정보가 있음  -> 클래스 이름은 같으니까 이걸로 가지고 오기 
                    arti_info = song_info.find_element(By.CSS_SELECTOR, ".e-9640-text.encore-text-body-small.encore-internal-color-text-subdued.UudGCx16EmBkuFPllvss.standalone-ellipsis-one-line")
