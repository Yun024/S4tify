...
class ChartData:
    ...
    def __init__(
        self,
        chartType: BugsChartType = BugsChartType.All,
        chartPeriod: BugsChartPeriod = BugsChartPeriod.Realtime,
        imageSize: int = 256,
        fetch: bool = True,
    ):
            ...
            for item in list:
                entry = ChartEntry(
                    ...
                    rank=int(
                        item["list_attr"]["rank"]),
                    peakPos=int(
                        item["list_attr"]["rank_peak"]),
                    lastPos=int(
                        item["list_attr"]["rank_last"]),
                )
